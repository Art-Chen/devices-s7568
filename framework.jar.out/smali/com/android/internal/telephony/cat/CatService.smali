...
.field private static final MSG_ID_DISPLAY_SEND_SS_FAILED:I = 0x16
...
# instance fields
.field private alphaidpresent:Z
...
.method private constructor <init>(Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/IccRecords;Landroid/content/Context;Lcom/android/internal/telephony/IccFileHandler;Lcom/android/internal/telephony/IccCard;Lcom/android/internal/telephony/IccSmsInterfaceManager;Lcom/android/internal/telephony/PhoneBase;)V
    ...
    .line 216
    iput-boolean v3, p0, Lcom/android/internal/telephony/cat/CatService;->alphaidpresent:Z
...
.method private handleCallControlResultNoti(Ljava/lang/String;)V
    ...
    .line 697
    .local v12, callControlResult_alphaidpresent:Z
    const/4 v9, 0x0

    .line 698
    .local v9, alphaid_len:I
    const/16 v1, 0x40
    ...
    .line 700
    .local v8, alpha_id_display:Ljava/lang/String;
    const/16 v16, 0x0

    .line 701
    .local v16, length_of_mod:B
    const/16 v22, 0x0
    ...
    .line 703
    .local v19, modified_ussd_string:Ljava/lang/String;
    const/16 v18, 0x0

    .line 705
    .local v18, modified_sms_dest_address:Ljava/lang/String;
    const/4 v10, 0x0
    ...
    const-string v2, "The call control result by SIM : callControlResult_alphaidpresent = "
    ...
    const-string v2, "The call control result by SIM : alpha_id_display = "
    ...
    invoke-static {v13}, Lcom/android/internal/telephony/cat/CallType;->fromInt(I)Lcom/android/internal/telephony/cat/CallType;
...
.method private handleProactiveCommand(Lcom/android/internal/telephony/cat/CommandParams;)V
    ...
    iput-boolean v2, v0, Lcom/android/internal/telephony/cat/CatService;->alphaidpresent:Z
...
.method private sendTerminalResponse(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/ResultCode;Lcom/android/internal/telephony/SSReleaseCompleteNotification;Lcom/android/internal/telephony/cat/ResponseData;)V
    ...
    .line 1460
    iget-boolean v6, p0, Lcom/android/internal/telephony/cat/CatService;->alphaidpresent:Z
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(I)Landroid/os/Message;

    move-result-object v6

    const-wide/16 v7, 0xfa0

    invoke-virtual {p0, v6, v7, v8}, Lcom/android/internal/telephony/cat/CatService;->sendMessageDelayed(Landroid/os/Message;J)Z
