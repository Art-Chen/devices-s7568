...
.method private handleConnectivityChange(IZ)V
    ...
    .line 2124
    sget-boolean v13, Lcom/android/server/ConnectivityService;->VDBG:Z
    ...
    invoke-direct {v9, v13, v14}, Landroid/net/LinkAddress;-><init>(Ljava/net/InetAddress;I)V
    :try_end_0
    .catch Ljava/net/UnknownHostException; {:try_start_0 .. :try_end_0} :catch_0

    .end local v8           #mapn_destination:Landroid/net/LinkAddress;
    .local v9, mapn_destination:Landroid/net/LinkAddress;
    move-object v8, v9

    .line 2176
    .end local v9           #mapn_destination:Landroid/net/LinkAddress;
    .restart local v8       #mapn_destination:Landroid/net/LinkAddress;
    :goto_3
    new-instance v13, Landroid/net/RouteInfo;

    const/4 v14, 0x0

    invoke-direct {v13, v8, v14}, Landroid/net/RouteInfo;-><init>(Landroid/net/LinkAddress;Ljava/net/InetAddress;)V

    invoke-virtual {v10, v13}, Landroid/net/LinkProperties;->addRoute(Landroid/net/RouteInfo;)V
    ...
    invoke-direct {p0, v10, v2, v13}, Lcom/android/server/ConnectivityService;->updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;Z)Z
    ...
    invoke-direct {p0, v13}, Lcom/android/server/ConnectivityService;->loge(Ljava/lang/String;)V
...
.method public removeRouteToHostAddress(I[B)Z
    ...
    const-string v8, "removeRouteToHostAddress on invalid network: "
    ...
    const-string v8, "removeRouteToHostAddress on down network ("
    ...
    const-string v8, "removeRouteToHostAddress got "
...
.method public startUsingNetworkFeature(ILjava/lang/String;Landroid/os/IBinder;)I
    ...
    const-string v19, "startUsingNetworkFeature failed. Cannot find from mNetTrackers for net "
