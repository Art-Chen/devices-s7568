...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/webkit/CallbackProxy$14;,
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 308
    .local v70, startedUrl:Ljava/lang/String;
    ...
    .line 315
    .end local v70           #startedUrl:Ljava/lang/String;
    :pswitch_2
    move-object/from16 v0, p1
    ...
    .line 316
    .local v44, finishedUrl:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 323
    .end local v44           #finishedUrl:Ljava/lang/String;
    :pswitch_3
    move-object/from16 v0, p0
    ...
    .line 346
    .local v40, description:Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 347
    .local v43, failUrl:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 353
    .end local v40           #description:Ljava/lang/String;
    .end local v43           #failUrl:Ljava/lang/String;
    ...
    .line 355
    .local v61, readerData:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 360
    .end local v61           #readerData:Ljava/lang/String;
    :pswitch_8
    move-object/from16 v0, p0
    ...
    .line 362
    .local v64, recogData:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 368
    .end local v64           #recogData:Ljava/lang/String;
    :pswitch_9
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 372
    .local v41, dontResend:Landroid/os/Message;
    move-object/from16 v0, p0
    ...
    .line 381
    .end local v41           #dontResend:Landroid/os/Message;
    ...
    .line 382
    .local v59, overrideUrl:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 392
    .end local v58           #override:Z
    .end local v59           #overrideUrl:Ljava/lang/String;
    ...
    check-cast v45, Landroid/webkit/HttpAuthHandler;

    .line 394
    .local v45, handler:Landroid/webkit/HttpAuthHandler;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 402
    .end local v45           #handler:Landroid/webkit/HttpAuthHandler;
    ...
    .line 405
    .local v52, map:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;"
    move-object/from16 v0, p0
    ...
    .line 412
    .end local v52           #map:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;"
    :pswitch_d
    move-object/from16 v0, p0
    ...
    .line 463
    .local v38, contentLength:Ljava/lang/Long;
    move-object/from16 v0, p0
    ...
    .end local v38           #contentLength:Ljava/lang/Long;
    :pswitch_13
    move-object/from16 v0, p0
    ...
    .line 558
    .local v57, origin:Ljava/lang/String;
    ...
    .end local v52           #map:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;"
    .end local v57           #origin:Ljava/lang/String;
    :pswitch_1b
    move-object/from16 v0, p0
    ...
    .line 581
    .end local v55           #notificationID:I
    :pswitch_1d
    move-object/from16 v0, p0
    ...
    .line 594
    .restart local v57       #origin:Ljava/lang/String;
    const-string v4, "callback"
    ...
    .line 610
    .local v47, iconUrl:Ljava/lang/String;
    ...
    .end local v27           #callback:Landroid/webkit/NotificationPermissions$Callback;
    .end local v47           #iconUrl:Ljava/lang/String;
    .end local v52           #map:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;"
    :pswitch_20
    move-object/from16 v0, p0
    ...
    check-cast v33, Landroid/webkit/JsResult;
    ...
    .line 633
    invoke-virtual/range {v33 .. v33}, Landroid/webkit/JsResult;->setReady()V
    ...
    invoke-direct {v9, v0, v1}, Landroid/webkit/CallbackProxy$7;-><init>(Landroid/webkit/CallbackProxy;Landroid/webkit/JsResult;)V
    ...
    check-cast v33, Landroid/webkit/JsPromptResult;
    ...
    .line 742
    invoke-virtual/range {v33 .. v33}, Landroid/webkit/JsPromptResult;->setReady()V
    ...
    .line 747
    .local v42, factory:Landroid/view/LayoutInflater;
    const v4, 0x1090051
    ...
    .line 785
    .end local v42           #factory:Landroid/view/LayoutInflater;
    ...
    new-instance v9, Landroid/webkit/CallbackProxy$13;

    move-object/from16 v0, p0

    move-object/from16 v1, v33

    invoke-direct {v9, v0, v1}, Landroid/webkit/CallbackProxy$13;-><init>(Landroid/webkit/CallbackProxy;Landroid/webkit/JsResult;)V
    ...
    .line 842
    .end local v51           #m:Ljava/lang/String;
    :cond_f
    invoke-virtual/range {v33 .. v33}, Landroid/webkit/JsResult;->setReady()V
    ...
    .line 885
    .local v69, sourceID:Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 889
    .local v56, numberOfMessageLevels:I
    if-ltz v54, :cond_11
    ...
    aget-object v53, v4, v54

    .line 896
    .local v53, messageLevel:Landroid/webkit/ConsoleMessage$MessageLevel;
    move-object/from16 v0, p0
    ...
    .line 900
    const-string v50, "Web Console"

    .line 901
    .local v50, logTag:Ljava/lang/String;
    ...
    .line 903
    .local v49, logMessage:Ljava/lang/String;
    sget-object v4, Landroid/webkit/CallbackProxy$14;->$SwitchMap$android$webkit$ConsoleMessage$MessageLevel:[I

    invoke-virtual/range {v53 .. v53}, Landroid/webkit/ConsoleMessage$MessageLevel;->ordinal()I
    ...
    .line 925
    .end local v31           #message:Ljava/lang/String;
    .end local v48           #lineNumber:I
    .end local v49           #logMessage:Ljava/lang/String;
    .end local v50           #logTag:Ljava/lang/String;
    .end local v53           #messageLevel:Landroid/webkit/ConsoleMessage$MessageLevel;
    .end local v54           #msgLevel:I
    .end local v56           #numberOfMessageLevels:I
    .end local v69           #sourceID:Ljava/lang/String;
    :pswitch_2f
    move-object/from16 v0, p0
    ...
    check-cast v39, Landroid/webkit/CallbackProxy$UploadFileMessageData;

    .line 933
    .local v39, data:Landroid/webkit/CallbackProxy$UploadFileMessageData;
    move-object/from16 v0, p0

    iget-object v4, v0, Landroid/webkit/CallbackProxy;->mWebChromeClient:Landroid/webkit/WebChromeClient;

    invoke-virtual/range {v39 .. v39}, Landroid/webkit/CallbackProxy$UploadFileMessageData;->getUploadFile()Landroid/webkit/CallbackProxy$UploadFile;

    move-result-object v9

    invoke-virtual/range {v39 .. v39}, Landroid/webkit/CallbackProxy$UploadFileMessageData;->getAcceptType()Ljava/lang/String;
    ...
    .line 939
    .end local v39           #data:Landroid/webkit/CallbackProxy$UploadFileMessageData;
    :pswitch_31
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 940
    .local v37, cUrl:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 951
    .end local v37           #cUrl:Ljava/lang/String;
    :pswitch_32
    move-object/from16 v0, p0
    ...
    .line 958
    .restart local v46       #host:Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    check-cast v68, Landroid/webkit/SearchBoxImpl;

    .line 974
    .local v68, searchBox:Landroid/webkit/SearchBoxImpl;
    move-object/from16 v0, p1
    ...
    .line 975
    .local v72, suggestions:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 979
    .end local v68           #searchBox:Landroid/webkit/SearchBoxImpl;
    .end local v72           #suggestions:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :pswitch_36
    move-object/from16 v0, p0
    ...
    .line 982
    .local v34, account:Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 990
    .end local v34           #account:Ljava/lang/String;
    ...
    .line 997
    .restart local v68       #searchBox:Landroid/webkit/SearchBoxImpl;
    move-object/from16 v0, p1
    ...
    .line 998
    .local v73, supported:Ljava/lang/Boolean;
    ...
    .line 1002
    .end local v68           #searchBox:Landroid/webkit/SearchBoxImpl;
    .end local v73           #supported:Ljava/lang/Boolean;
    :pswitch_39
    move-object/from16 v0, p0
    ...
    .line 1004
    .local v71, success:Ljava/lang/Boolean;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 1010
    .end local v68           #searchBox:Landroid/webkit/SearchBoxImpl;
    .end local v71           #success:Ljava/lang/Boolean;
    :pswitch_3a
...
.method public onNotificationManagershowPrompt(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/webkit/NotificationPermissions$Callback;)V
    ...
    const-string v6, "Inside CallbackProxy onNotificationManagershowPrompt Bitmap is "
