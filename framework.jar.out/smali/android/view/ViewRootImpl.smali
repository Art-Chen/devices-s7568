...
.method private destroyHardwareRenderer()V
    ...
    invoke-virtual {v0, v2}, Landroid/view/HardwareRenderer;->setRequested(Z)V
    ...
    iput-boolean v2, v0, Landroid/view/View$AttachInfo;->mHardwareAccelerated:Z
...
.method private performTraversals()V
    ...
    .line 1043
    .local v80, windowSizeMayChange:Z
    move-object/from16 v0, p0
    ...
    new-instance v69, Landroid/graphics/Point;

    invoke-direct/range {v69 .. v69}, Landroid/graphics/Point;-><init>()V

    .line 1090
    .local v69, size:Landroid/graphics/Point;
    ...
    .end local v69           #size:Landroid/graphics/Point;
    ...
    invoke-virtual {v0, v4, v5, v6, v11}, Landroid/graphics/Rect;->set(IIII)V
    ...
    .line 1171
    .local v65, res:Landroid/content/res/Resources;
    move-object/from16 v0, p0
    ...
    .end local v65           #res:Landroid/content/res/Resources;
    :cond_e
    move-object/from16 v0, v18
    ...
    .restart local v65       #res:Landroid/content/res/Resources;
    :cond_1a
    const/4 v4, 0x0
    ...
    .line 1206
    .restart local v69       #size:Landroid/graphics/Point;
    move-object/from16 v0, v35
    ...
    .restart local v66       #resizeMode:I
    :cond_21
    if-nez v66, :cond_22
    ...
    .line 1346
    .local v79, windowShouldResize:Z
    :goto_a
    const/4 v4, 0x0
    ...
    .end local v67           #restoreCount:I
    .end local v68           #scrolling:Z
    .end local v81           #yoff:I
    :cond_35
    :goto_12
    move-object/from16 v0, p0
    ...
    .end local v54           #len$:I
    .end local v64           #relayoutResult:I
    .end local v79           #windowShouldResize:Z
    :cond_3a
    const/16 v20, 0x0
    ...
    .restart local v64       #relayoutResult:I
    .restart local v79       #windowShouldResize:Z
    :cond_3c
    const/16 v52, 0x0
    ...
    .restart local v46       #hwRendererCanvas:Landroid/view/HardwareCanvas;
    .restart local v53       #layerCanvas:Landroid/view/HardwareCanvas;
    .restart local v67       #restoreCount:I
    .restart local v73       #surfaceGenerationId:I
    .restart local v77       #visibleInsetsChanged:Z
    :cond_43
    const/16 v68, 0x0
...
.method public forceRelayout(Landroid/view/WindowManager$LayoutParams;)V
    ...
    iget v1, p1, Landroid/view/WindowManager$LayoutParams;->splitMode:I
    ...
    iput v1, v0, Landroid/view/WindowManager$LayoutParams;->windowMode:I
